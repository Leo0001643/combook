...
public class VehicleVO {
    ...
    public static VehicleVO from(com.cambook.db.entity.CbVehicle v) {
        ...
        vo.setSeats(b2i(v.getSeats()));
        vo.setInspectionCode(v.getInspectionCode());
        vo.setInspectionExpiry(v.getInspectionExpiry() != null ? v.getInspectionExpiry().toString() : null);
        vo.setPhoto(v.getPhoto());
        vo.setPhotos(v.getPhotos());
        vo.setStatus(b2i(v.getStatus()));
