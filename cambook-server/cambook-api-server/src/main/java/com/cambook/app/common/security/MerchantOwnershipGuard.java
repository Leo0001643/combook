...
public final class MerchantOwnershipGuard {
    ...
    public static Long requireMerchantId() {
        ...
        if (id == null) throw new BusinessException(CbCodeEnum.TOKEN_INVALID);
        return id;
    }
    ...
    public static void assertOwnershipNonNull(Object resource, Long resourceMerchantId, String resourceType, Object resourceId) {
        if (resource == null) throw new BusinessException(CbCodeEnum.DATA_NOT_FOUND);
