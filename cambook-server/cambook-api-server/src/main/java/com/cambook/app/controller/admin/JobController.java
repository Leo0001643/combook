...
public class JobController {
    ...
    private static Map<String, Object> buildJob(Long id, String jobName, String jobGroup, String invokeTarget, String cronExpression, String status, String lastResult, String remark) {
