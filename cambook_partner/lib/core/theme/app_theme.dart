...
abstract class AppTheme {
  static ThemeData get light => ThemeData(
    ...
    textTheme: const TextTheme(
      ...
      bodySmall:   TextStyle(fontSize: 12, fontWeight: FontWeight.w500, color: AppColors.textSecond),
      ...
      labelMedium: TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: AppColors.textSecond),
      labelSmall:  TextStyle(fontSize: 11, fontWeight: FontWeight.w600, color: AppColors.textHint),
    ),
    ...
    appBarTheme: const AppBarTheme(
      ...
      titleTextStyle: AppTextStyles.whiteMd,
    ...
    textButtonTheme: TextButtonThemeData(
      style: TextButton.styleFrom(
        foregroundColor: AppColors.primary,
        textStyle: AppTextStyles.label2,
      ),
    ),
